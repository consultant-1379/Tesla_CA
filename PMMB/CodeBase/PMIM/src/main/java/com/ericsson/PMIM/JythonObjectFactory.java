...
public class JythonObjectFactory {
    ...
    public JythonObjectFactory(final PySystemState state, final Class interfaceType, final String moduleName, final String className) {
        try {
            this.interfaceType = interfaceType;
            final PyObject importer = state.getBuiltins().__getitem__(Py.newString("__import__"));
    ...
    public JythonObjectFactory(final Class interfaceType, final String moduleName, final String className) {
    ...
    public Object createObject(final Object arg1) {
        return klass.__call__(Py.java2py(arg1)).__tojava__(interfaceType);
    }

    public Object createObject(final Object arg1, final Object arg2) {
        return klass.__call__(Py.java2py(arg1), Py.java2py(arg2)).__tojava__(interfaceType);
    }

    public Object createObject(final Object arg1, final Object arg2, final Object arg3) {
        return klass.__call__(Py.java2py(arg1), Py.java2py(arg2), Py.java2py(arg3)).__tojava__(interfaceType);
    }

    public Object createObject(final Object args[], final String keywords[]) {
    ...
    public Object createObject(final Object... args) {
